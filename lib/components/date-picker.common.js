...
var _lib_toInteger = __webpack_require__("2cfd");
...
/* harmony default export */ var Calendarvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    canMove(arg, opts = {}) {
      ...
      if (isNumber_default()(arg)) position = 1;
    ...
    initStore() {
      ...
      this.store = new attributeStore_AttributeStore(this.$theme, this.$locale, this.attributes);
      ...
      pages.forEach(function (p) {
        ...
        p.days.forEach(function (d) {
          ...
          if (reset) {
            ...
            map = omit_default()(d.attributesMap, deletes);
